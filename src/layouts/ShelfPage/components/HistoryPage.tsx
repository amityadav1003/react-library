    ...
    useEffect(()=> {
        const fetchHistory =async () => {
            if(authState && authState.isAuthenticated){
                const url = `https://localhost:8443/api/histories/search/findBookByUserEmail?userEmail=${authState.accessToken?.claims.sub}&page=${currentPage-1}&size=5`
    ...
    return (
        <div className="mt-2">
            ...
            <>
                ...
                :
                <><h3 className="mt-3">Currently No history</h3><Link className="btn btn-primary" to={'seaarch'} >Search For New Book</Link></>
